...
import { color, delay, motion, AnimatePresence } from 'framer-motion'
...
const Sidebar = () => {
    ...
    return (
        ...
        >
            <div className='h-full bg-grey-800 bg-opacity-50 backdrop-blur-md p-4 flex flex-col border-r border-gray-700'>
                <motion.button
